...
"""
    ...
    response = client.chat.completions.create(
        model="gpt-4o-mini",
        messages=[
            {"role": "system", "content": "You are a helpful book recommendation assistant. Always respond with valid JSON only."},
    ...
    for pick in gpt_picks[:top_n]:
        ...
        result.append({
            'book_id': book_id,
            'title': book.get('title'),
            'score': None,  # GPT-based; no numeric score
